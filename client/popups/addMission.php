<div class="my_popup">
    <div class="my_popup_header">
        <div command>Ajouter une mission</div>
    </div>
    <div class="my_popup_content container">
        <h2 class="title rajdhani-bold">Ajouter Un nouvelle mission</h2>
        <form id="test" method="post" action="" onsubmit="return false;">
            ...
            <input name="entity_type" type="hidden" value="<?php echo OBJETS::fromName("MISSION") ?>" />
            <div class="row">
                <div class="col-6">
