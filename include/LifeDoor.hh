...
public:
    ...
    int                                         addPlanet(map<string, int> attr_int, map<string, string> attr_string);

    bool                                        deleteMission(string const name);
    bool                                        deleteMission(int const id);
    int                                         addMission(boost::json::object &item);
    int                                         addMission(map<string, int> attr_int, map<string, string> attr_string);
    ...
    int                                         addSpaceShip(map<string, int> attr_int, map<string, string> attr_string);

    int                                         addItem(boost::json::object &item);
    int                                         addItem(map<string, int> attr_int, map<string, string> attr_string);
    void                                        removeItem(int idItem, string name, OBJETS type);
    bool                                        deleteItem(int id);

    int                                         addGrade(boost::json::object &item);
    int                                         addGrade(map<string, int> attr_int, map<string, string> attr_string);
